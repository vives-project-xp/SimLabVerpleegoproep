...
<img src="../afbeeldingen/Instellingen%20Home%20Assistant.png" alt="Instelling Home Assistant" width="600" />

## Stap 2 apparaten en diensten

Klik op Apparaten en diensten.
<img src="../afbeeldingen/Home%20Assistant%20Apparaten%20en%20diensten.png" alt="Apparaten en Diensten Home Assistant" width="600" />

## Stap 3 kijken of MQTT al aanwezig is of toevoegen

3.1 Controleer of MQTT al in de lijst staat
<img src="../afbeeldingen/MQTT controleren.png" alt="Zigbee Home Automation bij Apparaten en Diensten" width="600" />
...
3.3 Zoek naar MQTT en klik erop
<img src="../afbeeldingen/integratie MQTT.png" alt="MQTT integratie toevoegen" width="600" />

3.4 Dan kom je op dit scherm en klik op het bovenste MQTT
<img src="../afbeeldingen/Wat wil je toevoegen.png" alt="Wat wil je toevoegen" width="600" />

3.5 Dan krijg je een scherm waar je de broker/server, username en password kan invullen

Broker/server:
<broker-ip>

Poort:
1883 (standaard MQTT poort)
...
3.6 Na de installatie zou MQTT in de lijst met integraties moeten staan
...
<img src="../afbeeldingen/Zigbee2MQTT_pagina.png" alt="Zigbee2MQTT pagina" width="600" />

## Stap 5 Permit Join aanzetten in Zigbee2MQTT

Klik linksonder op de knop Permit Join 
<img src="../afbeeldingen/Permit_Join_Zigbee2MQTT.png" alt="Permit Join in Zigbee2MQTT" width="600" />
...
<img src="../afbeeldingen/ESP32 toegevoegd.png" alt="ESP32 toegevoegd in Zigbee2MQTT" width="600" />
...
<img src="../afbeeldingen/Devices_Zigbee2MQTT.png" alt="Devices in Zigbee2MQTT" width="600" />

Dan kom je op deze pagina.
Klik daar op het blauwe icoontje.
<img src="../afbeeldingen/DevicesSherm_NaamVeranderen_Zigbee2MQTT.png" alt="Naam wijzigen in Zigbee2MQTT" width="600" />

Dan kom je op dit scherm.
<img src="../afbeeldingen/naamwijzigen_Zigbee2Mqtt.png" alt="Naam wijzigen scherm in Zigbee2MQTT" width="600" />
...
<img src="../afbeeldingen/controleerApparatenMQTTHome.png" alt="Controle van apparaten in MQTT" width="600" />
...
<img src="../afbeeldingen/potloodIcoonMQTTHome.png" alt="Potloodicoon in Home Assistant" width="600" />

Dan kom je op dit scherm.
<img src="../afbeeldingen/naamwijzigenHome.png" alt="Naam wijzigen in Home Assistant" width="600" />
...
1.1 Controleer of je apparaat in koppelmodus staat  
(raadpleeg de handleiding van je apparaat om te zien hoe dit moet)

1.2 Zet het apparaat dichter bij je Zigbee stick

1.3 Probeer het apparaat eerst te resetten

### 2. Nog steeds problemen met toevoegen?

2.1 Herstart Home Assistant  
→ Zet Home Assistant even uit en weer aan

2.2 Trek je Zigbee stick uit en steek hem opnieuw in  
→ Haal de stick uit de Raspberry Pi en steek hem opnieuw in

2.3 Zoek hulp online  
→ Raadpleeg de handleiding van je apparaat of zoek op forums

2.4 Controleer of MQTT verbonden is  
→ Controleer in Home Assistant of de MQTT integratie actief is.

2.5 Controleer of Zigbee2MQTT bereikbaar is
